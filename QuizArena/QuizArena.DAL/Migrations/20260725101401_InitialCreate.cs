        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    TimesAsked = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokeReason = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestCompetitionScore = table.Column<int>(type: "int", nullable: false),
                    WinCount = table.Column<int>(type: "int", nullable: false),
                    AverageAnswerMilliseconds = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimedOutCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Competitions_RoomParticipants_RoomParticipantId",
                        column: x => x.RoomParticipantId,
                        principalTable: "RoomParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Competitions_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AskedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompetitionQuestionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    StreakBonus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompetitionAnswers_Answers_SelectedAnswerId",
                        column: x => x.SelectedAnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompetitionAnswers_CompetitionQuestions_CompetitionQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionAnswers_CompetitionQuestionId",
                table: "CompetitionAnswers",
                column: "CompetitionQuestionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionAnswers_SelectedAnswerId",
                table: "CompetitionAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_CompetitionQuestions_Competition_Order",
                table: "CompetitionQuestions",
                columns: new[] { "CompetitionId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_CompetitionQuestions_Competition_Question",
                table: "CompetitionQuestions",
                columns: new[] { "CompetitionId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Competitions_Room_Score",
                table: "Competitions",
                columns: new[] { "RoomId", "TotalScore" });

            migrationBuilder.CreateIndex(
                name: "UX_Competitions_RoomParticipant",
                table: "Competitions",
                column: "RoomParticipantId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_OperationClaims_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_RoomParticipants_Room_User",
                table: "RoomParticipants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Status_Mode_Created",
                table: "Rooms",
                columns: new[] { "Status", "Mode", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "UX_Rooms_JoinCode",
                table: "Rooms",
                column: "JoinCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UX_UserAchievements_User_Achievement",
                table: "UserAchievements",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_UserOperationClaims_User_Claim",
                table: "UserOperationClaims",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStatistics_TotalScore_Desc",
                table: "UserStatistics",
                column: "TotalScore",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "UX_UserStatistics_User",
                table: "UserStatistics",
                column: "UserId",
                unique: true);
        }
